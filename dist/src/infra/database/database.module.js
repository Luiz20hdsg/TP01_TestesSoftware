...
const client_repository_1 = require("../../core/repositories/client-repository");
    ...
    (0, common_1.Module)({
        providers: [
            prisma_service_1.PrismaService,
            {
                ...
                useClass: prisma_client_repository_1.PrismaClientRepository,
            },
        ],
        exports: [client_repository_1.ClientRepository],
    })
], DatabaseModule);
